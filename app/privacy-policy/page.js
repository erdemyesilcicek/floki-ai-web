...
export default function PrivacyPolicy() {
  return (
    <div className={styles.container}>
      <Head>
        <title>Privacy Policy | Floki AI</title>
        <meta
          name="description"
          content="Learn more about Floki AI's privacy practices and how we protect your data."
        />
      </Head>
      <main className={styles.main}>
        <h1 className={styles.title}>Privacy Policy</h1>
        <p className={styles.description}>
          Welcome to Floki AI! Your privacy is extremely important to us. This Privacy Policy explains how we collect, 
        ...
        <section className={styles.section}>
          ...
          <p className={styles.description}>
            Floki AI is designed for children and families. We comply with children’s privacy laws, including COPPA and GDPR. Parental consent is required for users under 13 years of age.
          </p>
        </section>
